...
def runSVM_T_One_vs_All(distances, labels, targetTrainingIndice, targetTestingIndice):
...
def runSVM_T_One_vs_One(distances, semanticLabels, targetTrainingIndice, targetTestingIndice):
    # Construct base kernels
    baseKernels = []
    for i in range(len(distances)):
        distance = distances[i]
...
if __name__ == "__main__":
    ...
    for i in range(1,6,1):
        ...
        # predictions = runSVM_T_One_vs_All(distances, labels, targetTrainingIndices, testingIndiceList)
        predictions = runSVM_T_One_vs_One(distances, trueLabels, targetTrainingIndices, testingIndiceList)
